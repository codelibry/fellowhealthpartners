        ...
        <div class="title_text_line__top">
            <div class="row">
                <div class="col-lg-6 mb-2 mb-lg-0">
                    <?php if ($title) : ?>
                        <h2 class="h3 text-color-black"><?php echo $title; ?></h2>
                    <?php endif; ?>
                </div>
                <?php if ($content) : ?>
                    <div class="col-lg-6">
                        <div class="content-block text-color-black text--size--26">
                            <?php echo $content; ?>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <?php if ($bottom_title || $bottom_content) : ?>
            <div class="title_text_line__bottom">
                <div class="row">
                    <div class="col-lg-6 mb-2 mb-lg-0">
                        <?php if ($bottom_title) : ?>
                            <h2 class=" h4 text-color-primary"><?php echo $bottom_title; ?></h2>
                        <?php endif; ?>
                    </div>
