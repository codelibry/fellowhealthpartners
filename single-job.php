...
<main id="primary" class="site-main">
    ...
    <div class="container">
        <div class="back_block section section--spacing--md">
            <a href="/careers/" class="back-to-category text-color-orange font--weight--500">Back to Careers <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="title_block">
                            <h1 class="h3 font--weight--500 text-color-black"><?php the_title(); ?></h1>
                        </div>
                        <div class="job-apply">
            ...
            <div class="job-body row section section--spacing--lg">
                <div class="job-col col-12 col-lg-6">
                    <?php if (get_field('job_primary_responsibilities')) : ?>
                        <section>
                            <h3 class="h4 text--color--black_new">Primary Responsibilities</h3>
                            <div class="line"></div>
                    ...
                    <?php if (get_field('job_educationexperience')) : ?>
                        <section class="pt-2 pt-lg-10">
                            <h3 class="h4 text--color--black_new">Education/Experience</h3>
                            <div class="line"></div>
                            <div class="content-block text--color-gray text--size--26">
                ...
                <div class="job-col col-12 col-lg-6">
                    <?php if (get_field('job_skillsqualifications')) : ?>
                        <section>
                            <h3 class="h4 text--color--black_new">Skills/Qualifications</h3>
                            <div class="line"></div>
                            <div class="content-block text--color-gray text--size--26">
