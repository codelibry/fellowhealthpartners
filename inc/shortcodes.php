...
?>
    <section class="">
        <?php
        $choose_logos = get_field('choose_logos', 'options');
        $choose_logos_left_to_right = get_field('choose_logos_left_to_right', 'options');
        if ($choose_logos || $choose_logos_left_to_right) : ?>
            <div class="tickers-block__wrap slider">
                <div class="tickers-block__slider slider-left-direction">
                    <div class="tickers-block__slider-wrap">
                        <?php foreach ($choose_logos as $post) : ?>
                            <?php setup_postdata($post); ?>
                            <div class="tickers-block__slider-slide">
                ...
                <?php if ($choose_logos_left_to_right) : ?>
                    <div class="tickers-block__slider slider-right-direction">
                        <div class="tickers-block__slider-wrap">
                            <?php foreach ($choose_logos_left_to_right as $post) : ?>
                                <?php setup_postdata($post); ?>
                                <div class="tickers-block__slider-slide">
                                    <?php echo get_the_post_thumbnail($post, 'full') ?>
                                </div>
