...
if($mobile_image) {
	//print_r(aq_resize(removeParam($regs[1], 'id'), 775, 554, true, true, true ));
	$output .= '<div class="mobile-image"><img src="' . aq_resize(wp_get_attachment_url($mobile_image), 1024, 732, true, true, true ) .'" alt=""></div>';
} 
