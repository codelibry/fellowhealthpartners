...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <link rel="mask-icon" href="<?php echo get_stylesheet_directory_uri(); ?>/safari-pinned-tab.svg"
              color="#5bbad5">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="site-header__info d-md-flex align-items-center text-right">
                    <div class="site-header__contacts"><?php echo $fellow_options['header-text']; ?>
                        <a href="tel:<?php echo $fellow_options['phone']; ?>"
                           class="site-header__contacts-tel d-md-none"><?php echo $fellow_options['phone']; ?></a>
                    ...
                    <?php if ($fellow_options['header-button-url']) : ?>
                        <a href="<?php echo $fellow_options['header-button-url']; ?>" class="button"
                           target="_blank"><?php echo $fellow_options['header-button']; ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
